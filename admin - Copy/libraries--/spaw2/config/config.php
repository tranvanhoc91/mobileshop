...
SpawConfig::setStaticConfigItem(
  ...
  array(
    ...
    array(
      'dir'     => SpawConfig::getStaticConfigValue('SPAW_DIR').'../../medias/images/',
      'fsdir'   => SpawConfig::getStaticConfigValue('SPAW_ROOT').'../../medias/images/', // optional absolute physical filesystem path
      'caption' => 'Files', 
      'params'  => array(
